...
import { ReportFilter, InventoryByLocationReportItem, Warehouse, Item, Bin } from '../../types';
...
export default function InventoryByLocationReport() {
  ...
  const { 
    ...
    pagination,
    refetch 
  } = useFilteredList<InventoryByLocationReportItem, ReportFilter>({
    endpoint: '/reports/inventory-by-location',
  ...
  return (
    <div>
      <Card 
        title={t('reports.inventoryByLocationReport')}
